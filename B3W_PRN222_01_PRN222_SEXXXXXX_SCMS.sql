...
IF DB_ID('FA25_PRN222_3W_PRN222_01_G5_SCMS') IS NOT NULL
BEGIN
    ALTER DATABASE FA25_PRN222_3W_PRN222_01_G5_SCMS SET SINGLE_USER WITH ROLLBACK IMMEDIATE;
    DROP DATABASE FA25_PRN222_3W_PRN222_01_G5_SCMS;
END
GO

CREATE DATABASE FA25_PRN222_3W_PRN222_01_G5_SCMS;
GO

USE FA25_PRN222_3W_PRN222_01_G5_SCMS;
GO
